...
function EventCard({ event }: { event: Event }) {
  return (
    ...
    <Image
        key={transformGoogleDriveUrl(event.imageUrl)}
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid md:grid-cols-2 gap-8 items-start">
              <Card className="flex flex-col">
                <CardHeader>
                  <Image key={transformGoogleDriveUrl(images?.aboutSection?.url)} src={transformGoogleDriveUrl(images?.aboutSection?.url || 'https://placehold.co/600x400')} alt={images?.aboutSection?.alt || 'About the hive'} width={600} height={400} data-ai-hint={images?.aboutSection?.hint} className="rounded-lg object-cover aspect-video" />
                </CardHeader>
              ...
              <Card className="flex flex-col">
                <CardHeader>
                   <Image key={transformGoogleDriveUrl(images?.cslSection?.url)} src={transformGoogleDriveUrl(images?.cslSection?.url || 'https://placehold.co/600x400')} alt={images?.cslSection?.alt || 'CSL Classes'} width={600} height={400} data-ai-hint={images?.cslSection?.hint} className="rounded-lg object-cover aspect-video" />
                </CardHeader>
                <CardContent className="flex-grow space-y-4">
