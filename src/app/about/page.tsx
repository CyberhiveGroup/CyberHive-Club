    ...
    <div className="container mx-auto px-4 py-12 md:px-6 md:py-20">
      ...
      <section className="mt-20">
        <div className="text-center">
          <h2 className="text-3xl font-headline font-bold tracking-tighter sm:text-4xl md:text-5xl">Meet the Team</h2>
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 lg:[&>*:nth-child(even)]:mt-12">
          {teamMembers.map((member) => (
            <Card key={member.id} className="text-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-primary/20">
